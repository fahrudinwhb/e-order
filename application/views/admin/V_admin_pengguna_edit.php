  ...
  <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="artikel-list-body col-xs-12 no-padding">
                        <div class="col-xs-4 left-list-body">
                            <div>
                                <div class="artikel-img-preview-wrap">
                                  <img src="<?php echo base_url('').$pengguna[0]['GAMBAR'] ?>" class="img-responsive" id="imgPreview">
                                  <div class="artikel-img-preview">
                                      <span class="article-btn-wrap">
                                          <button class="icon-article-btn btn btn-info"><i class="fa fa-upload" aria-hidden="true"></i>Pilih Gambar</button>
                        ...
                        <div class="col-xs-8 right-list-body">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="id" value="<?php echo $pengguna[0]['ID_PENGGUNA'] ?>" required readonly>
                                </div>
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <span class="btn btn-default">Nama</span>
                                     </span>
                                    <input type="text" class="form-control" name="nama" value="<?php echo $pengguna[0]['NAMA_PENGGUNA'] ?>" required>
                                </div>
                                <div class="input-group">
                                    <span class="input-group-btn">
                                    ...
                                    <input type="hidden" class="form-control" name="password" value="<?php echo $pengguna[0]['PASSWORD'] ?>" required>
                                </div>
                        </div>
                        <div class="col-xs-12">
                            <div id="submitWrap">
    ...
    $(document).ready(function(){
        ...
        $("#form-artikel").submit(function(event){
            ...
            $.ajax({
                type : 'POST',
                url : '<?php echo site_url('admin/pengguna_edit')?>',
                data : formData,
                cache: false,
                contentType: false,
                processData: false,
                ...
                success : function(berhasil){
                    // alert(berhasil);
                    swal('Berhasil Mengedit Pengguna','','success').then(function() {
