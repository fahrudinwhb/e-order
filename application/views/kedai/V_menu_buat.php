  ...
  <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-xs-8 right-list-body">
                            ...
                            <div class="input-group">
                                <span class="input-group-btn">
                                 ...
                                 <select class="form-control" name="baru" required>
                                     <option value="0">Tidak</option>
                                     <option value="1">Ya</option>
                                 </select>
                            </div>
                            <input type="hidden" name="id_kedai" value="<?php echo $this->session->userdata('kedai')[0]['ID_KEDAI']; ?>">
                        </div>
                        <div class="col-xs-12">
                            <div id="submitWrap">
    ...
    $(document).ready(function(){
        ...
        $("#form-artikel").submit(function(event){
            ...
            $.ajax({
                type : 'POST',
                url : '<?php echo site_url('kedai/menu_buat')?>',
                data : formData,
                cache: false,
                contentType: false,
                processData: false,
                ...
                success : function(berhasil){
                    swal('Berhasil Menambah Menu','','success').then(function() {
